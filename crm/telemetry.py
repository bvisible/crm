...
# //// Neoffice — upstream imports is_pulse_enabled from frappe.utils.telemetry.
# //// That helper landed in Frappe v16; it does not exist in v15 (not even in
# //// frappe/frappe version-15), so the bare import raised ImportError and took
# //// this whole module down with it — meaning the `daily` scheduler entry
# //// crm.telemetry.capture_feature_state failed on every instance of the fleet.
# //// The fallback returns False: no pulse, no telemetry, which is what we want
# //// on customer sites anyway. Drop this shim once the fleet is on v16.
try:
