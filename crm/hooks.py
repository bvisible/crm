...
# //// Neoffice — upstream runs crm.demo.api.create_demo_data when the Setup
# //// Wizard completes: it creates demo USERS plus fake leads, deals, notes,
# //// tasks and call logs. Our instances are provisioned for real customers,
# //// where seeded fiction is indistinguishable from their own data. Disabled
# //// at the v1.83.0 merge. Re-enable only on a demo site.
